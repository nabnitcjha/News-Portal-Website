            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img src="{{asset('backend/assets/images/users/user-3.jpg')}}" class="img-fluid rounded-circle" alt="user-img">
                            </div>
                        </div>
                        <div class="col">
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img src="{{asset('backend/assets/images/users/user-4.jpg')}}" class="img-fluid rounded-circle" alt="user-img">
                            </div>
                        </div>
                        <div class="col">
            ...
            <div class="widget-rounded-circle card">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img src="{{asset('backend/assets/images/users/user-5.jpg')}}" class="img-fluid rounded-circle" alt="user-img">
                            </div>
                        </div>
                        <div class="col">
            ...
            <div class="widget-rounded-circle card bg-blue">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col-auto">
                            <div class="avatar-lg">
                                <img src="{{asset('backend/assets/images/users/user-6.jpg')}}" class="img-fluid rounded-circle img-thumbnail" alt="user-img">
                            </div>
                        </div>
                        <div class="col">
                                ...
                                <tbody>
                                        ...
                                        <td id="tooltip-container">
                                            <div class="avatar-group">
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                    <img src="{{asset('backend/assets/images/users/user-1.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                                                    <img src="{{asset('backend/assets/images/users/user-2.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson">
                                                    <img src="{{asset('backend/assets/images/users/user-3.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Username">
                                                    <img src="{{asset('backend/assets/images/users/user-5.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                    <img src="{{asset('backend/assets/images/users/user-4.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                    <img src="{{asset('backend/assets/images/users/user-6.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
        
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Username">
                                                    <img src="{{asset('backend/assets/images/users/user-7.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                            </div>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                    <img src="{{asset('backend/assets/images/users/user-9.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
        
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty">
                                                    <img src="{{asset('backend/assets/images/users/user-10.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="avatar-group">
                                                ...
                                                <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson">
                                                    <img src="{{asset('backend/assets/images/users/user-8.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                                                </a>
