                            ...
                            <div class="main_section">
                                <div class="row">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                        ...
                                        <div class="contact-form">
                                            <span class="wpcf7-form-control-wrap sub_title"><input type="password" name="sub_title" value="" size="40" class="wpcf7-form-control wpcf7-text" aria-invalid="false" placeholder="Password" type="password" name="password" required /></span>
                                        </div>
                                    </div>
