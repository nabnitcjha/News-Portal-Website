				...
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-3 col-md-4">
							...
							<div class="facebook-content">
								<div class="twitter-timeline twitter-timeline-rendered" style="display: flex; width: 410px; max-width: 100%; margin-top: 0px; margin-bottom: 0px;"><iframe id="twitter-widget-0" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen="true" class="" style="position: static; visibility: visible; width: 279px; height: 220px; display: block; flex-grow: 1;" title="Twitter Timeline" src=" "></iframe></div>
					...
					<div class="col-lg-6 col-md-6">
						<div class="themesBazar_widget">
							<div class="textwidget">
								<p><img loading="lazy" class="aligncenter size-full wp-image-74" src="{{asset('frontend/assets/images/biggapon-1.gif')}}" alt="" width="100%" height="auto"></p>
							</div>
						</div>
					</div>
					<div class="col-lg-6 col-md-6">
									...
									<div class="tab-pane fade active show" id="Info-tabs1" role="tabpanel" aria-labelledby="categori-tab1 ">
										<div class="row">
											...
											<div class="themesBazar-4 themesBazar-m2">
												<div class="sec-two-wrpp">
													<div class="section-two-image">
														<a href=" "><img class="lazyload" src="{{asset('frontend/assets/images/lazy.jpg')}}"></a> <a href=" " class="mediam-icon"><i class="la la-play"></i></a>
													</div>
													<h5 class="sec-two-title">
														<a href=" ">Coaching centers to stay closed during SSC exams </a>
													</h5>
											...
											<div class="item">
												<div class="photo">
													<a class="themeGallery" href="{{asset('frontend/assets/images/6786.jpg')}}">
														<img src="{{asset('frontend/assets/images/lazy.jpg')}}" alt="PHOTO"></a>
				...
				<div class="footer-menu">
					<div class="menu-footer-menu-container">
						<ul id="menu-footer-menu" class="menu">
							<li id="menu-item-550" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-550"><a href=" ">ABOUT ALL</a></li>
